...
const Checkout = ({cart, order, onCaptureCheckout, error}) => {
    ...
    const Form = () => activeStep === 0
        ...
        : <PaymentForm shippingData={shippingData} timeout={timeout} checkoutToken={checkoutToken} backStep={backStep} nextStep={nextStep} onCaptureCheckout={onCaptureCheckout}/>
